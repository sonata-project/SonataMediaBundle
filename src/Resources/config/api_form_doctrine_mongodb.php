...
return static function (ContainerConfigurator $containerConfigurator): void {
    ...
    $containerConfigurator->services()
        ...
        ->set('sonata.media.api.form.type.doctrine.media', ApiDoctrineMediaType::class)
            ->tag('form.type')
            ->args([
        ...
        ->set('sonata.media.api.form.type.media', ApiMediaType::class)
            ->tag('form.type')
            ->args([
        ...
        ->set('sonata.media.api.form.type.gallery', ApiGalleryType::class)
            ->tag('form.type')
            ->args([
                new ReferenceConfigurator('jms_serializer.metadata_factory'),
                new ReferenceConfigurator('doctrine_mongodb'),
        ...
        ->set('sonata.media.api.form.type.gallery_item', ApiGalleryItemType::class)
            ->tag('form.type')
            ->args([
                new ReferenceConfigurator('jms_serializer.metadata_factory'),
                new ReferenceConfigurator('doctrine_mongodb'),
