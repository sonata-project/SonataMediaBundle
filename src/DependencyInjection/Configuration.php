...
final class Configuration implements ConfigurationInterface
{
    ...
    {
        // FIXME: add filesystem configuration
    }
                    ...
                    ->children()
                        ->arrayNode('file')
                            ...
                            ->children()
                                ...
                                ->scalarNode('resizer')->defaultNull()->end()
                                ->scalarNode('filesystem')->defaultValue('default.storage')->end()
        ...
        $node
            ->children()
                ->arrayNode('messenger')
                    ...
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('generate_thumbnails_bus')->defaultValue('messenger.default_bus')->end()
                    ->end()
                ->end()
            ->end();
    }
