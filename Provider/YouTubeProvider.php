...
class YouTubeProvider extends BaseVideoProvider {
    ...
    public function getHelperProperties(MediaInterface $media, $format, $options = array()) {
        ...
        $default_player_attributes = array(
        ...
        $player_parameters = array_merge($default_player_parameters, isset($options['player_parameters']) ? $options['player_parameters'] : array());

        $box = $this->getBoxHelperProperties($media, $format, $options);

        $player_attributes = array_merge($default_player_attributes, isset($options['player_attributes']) ? $options['player_attributes'] : array(), array(
            'width' => $box->getWidth(),
