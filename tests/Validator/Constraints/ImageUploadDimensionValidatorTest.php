...
final class ImageUploadDimensionValidatorTest extends ConstraintValidatorTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->imageProvider = $this->createMock(ImageProvider::class);
     ...
     *
     * @see https://github.com/symfony/symfony/blob/5.4/src/Symfony/Component/Validator/Test/ConstraintValidatorTestCase.php#L298-L301
     */
