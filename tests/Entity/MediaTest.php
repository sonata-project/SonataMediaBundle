...
class MediaTest extends TestCase
{
    ...
    public function testSetGet(): void
    {
        ...
        static::assertSame(2.0, $media->getLength());
        ...
        static::assertInstanceOf(\DateTimeInterface::class, $media->getCdnFlushAt());
        static::assertInstanceOf(\DateTimeInterface::class, $media->getCreatedAt());
